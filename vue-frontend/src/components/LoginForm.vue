<template>
  ...
  >
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <h2 v-else class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-white">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <form @submit.prevent="submitForm" class="space-y-6">
        <div>
          <label for="email" class="block text-sm/6 font-medium text-white">Adres email</label>
          <div class="mt-2">
            <input
              type="email"
              name="email"
        ...
        <div>
          <label for="password" class="block text-sm/6 font-medium text-white">Hasło</label>
          <div class="mt-2">
            <input
              type="password"
              name="password"
